					  ...
					  Texture* hitBoxTexture)
{
	...
	m_mookTexture->LoadTexture(m_graphics, "data\\textures\\mookSpritesheet.png");

	m_kingMookTexture = new Texture();
	m_kingMookTexture->LoadTexture(m_graphics, "data\\textures\\kingMookSpritesheet.png");

	m_mookPortraitTexture = new Texture();
	m_mookPortraitTexture->LoadTexture(m_graphics, "data\\textures\\UI\\mook_hud_portrait.png");

	m_kingMookPortraitTexture = new Texture();
	m_kingMookPortraitTexture->LoadTexture(m_graphics, "data\\textures\\UI\\kingMook_hud_portrait.png");
