...
void Game::Init(Window* window, Graphics* graphics, Input* input, GameStateManager* gameStateManager, CutsceneManager* cutsceneManager, EventManager* eventManager)
{
